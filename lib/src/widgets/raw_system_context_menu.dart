...
class RawSystemContextMenu extends StatefulWidget {
  ...
  factory RawSystemContextMenu.editableText({
    ...
    return RawSystemContextMenu._(
      ...
      anchor: TextSelectionToolbarAnchors.getSelectionRect(
        editableTextState.renderEditor,
        glyph.startGlyphHeight,
        glyph.endGlyphHeight,
        editableTextState.renderEditor.getEndpointsForSelection(
  ...
  ///
  /// Currently [RawSystemContextMenu] is only supported with an active
  ...
  static List<IOSSystemContextMenuItem> getDefaultItems(RawEditorState editableTextState) {
